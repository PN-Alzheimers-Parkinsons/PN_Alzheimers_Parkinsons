...
class Transition:
    def __init__(self, in_arcs, out_arcs, inhib_arcs, catal_arcs, rate_functions, transition_id, label, distribution_type):
    ...
    def fire(self, time_step):
        ...
        if self.distribution_type[0] == "grf":
            random_integer = random.gauss(self.distribution_type[1],self.distribution_type[1]*4) # have self.distribution_type[2]*0.1, self.distribution_type[1]]*0.1 for the standard deviation gives a very smooth curve
            print(random_integer)
            #print(pn.a)
            self.distribution_type[1] = self.distribution_type[3](pn.a) #can pass run_step__tokens into here.
            #print(self.distribution_type[3](pn.a)) #FILIP
        #uniform
...
class PetriNet:
    ...
    """
    def __init__(self, number_of_runs): #bsl: switched order for syntax
