...
#BrandonAdded. These guys have scaling functions which I stil need to add. chol_mp scales the vmax of all 3 of these guys... can't think why though. I think its pretty important.
...
rate_t_C = lambda a: 1
rate_t_D = lambda a: 1
#rate_t_dephos_tauP = lambda a: vmax_t_dephos_tauP*a['p_chol_ER']/(Km_t_CYP46A1_metab+a['p_chol_ER']) problem
