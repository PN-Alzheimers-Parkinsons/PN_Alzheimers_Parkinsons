...
#                    distribution_type = ["grf", 0.1, r_t_LDLR_endocyto])
...
#                     output_place_ids         =  ['p_chol_PM'],
#                     output_arc_weights =  [1],
#                     distribution_type = ["grf",0.1,r_t_chol_trans_ER_PM])   
...
#                     output_arc_weights =  [1], 
#                     distribution_type = ["grf",0.1,rate_t_CYP27A1_metab])                                          
...
#                     output_arc_weights =  [1], 
#                     distribution_type = ["grf",0.1,rate_t_CYP11A1_metab])  
...
#                     output_arc_weights =  [1], 
#                     distribution_type = ["grf",0.1,rate_t_CYP7B1_metab])                                                  
...
#                     output_arc_weights =  [1], 
#                     distribution_type = ["grf",0.1,rate_t_CYP46A1_metab])                                                  
