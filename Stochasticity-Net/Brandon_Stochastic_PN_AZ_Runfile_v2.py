...
#                     output_place_ids         =  [], 
#                     output_arc_weights =  [], 
#                     distribution_type = ["grf",0.1,r_t_NCX_PMCA, fc_t_NCX_PMCA])
...
#     # Discrete on/of-switches calcium pacemaking
    ...
    pn.add_transition(transition_id = 't_A',
                    ...
                    distribution_type = ["calcium",0,rate_t_A, fc_t_A]) #in HFPN, there is a delay of 0.5 s, maybe we need to be careful of this?
    ...
    pn.add_transition(transition_id = 't_B',
                    ...
                    distribution_type = ["calcium",0,rate_t_B, fc_t_B])#in HFPN, there is a delay of 0.5 s, maybe we need to be careful of this?
    ...
    #                 distribution_type = ["calcium",0,rate_t_C, fc_t_C])
...
#                     distribution_type = ["grf",0.1,r_t_RTN3_dys_lyso])
    ...
    run_save_name = "calcium_clock_v1"
